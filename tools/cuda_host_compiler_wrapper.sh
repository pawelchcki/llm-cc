...
# pinned libstdc++ headers/runtime in addition to its glibc 2.28 sysroot. No
...
sysroot_root="${exec_root}/external/+http_archive+cuda_host_toolchain/x86_64-buildroot-linux-gnu/sysroot"
